...
const createAndLogError = (asyncThrow, message, ...optionalParams) => {
  ...
  return console.error("%cQWIK ERROR", STYLE, err.message, ...optionalParams, err.stack), asyncThrow && setTimeout(() => {
    throw err;
  }, 0), err;
};
...
class JSXNodeImpl {
  constructor(type, varProps, constProps, children, flags, key = null) {
    if (this.type = type, this.varProps = varProps, this.constProps = constProps, this.children = children, this.flags = flags, this.key = key, this._proxy = null, qDev) ;
  }
  get props() {
