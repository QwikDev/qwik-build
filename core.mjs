    ...
    function descendContentToProject(children, host) {
        ...
        if (children.length) {
            ...
            for (let i = 0; i < children.length; i++) {
                ...
                const slotName = String((isJSXNode(child) && directGetPropsProxyProp(child.varProps, child.constProps, QSlot)) ||
                    QDefaultSlot);
 ...
 */
const directGetPropsProxyProp = (varProps, constProps, prop) => {
