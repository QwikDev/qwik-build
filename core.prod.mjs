    ...
    if ("string" == typeof tagName) {
        ...
        if (assertElement(elm), immutable) {
            for (const prop in immutable) {
                ...
                prop.startsWith(PREVENT_DEFAULT) && registerQwikEvent$1(prop.slice(PREVENT_DEFAULT.length), rCtx.$static$.$containerState$);
...
const injectQContainer = containerEl => {
    directSetAttribute(containerEl, "q:version", "0.106.0"), directSetAttribute(containerEl, "q:container", "resumed"), 
