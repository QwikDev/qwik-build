...
const _renderSSR = async (node, opts) => {
    ...
    containerAttributes["q:container"] = "paused", containerAttributes["q:version"] = "1.9.0", 
...
const injectQContainer = containerEl => {
    directSetAttribute(containerEl, "q:version", "1.9.0"), directSetAttribute(containerEl, "q:container", "resumed"), 
