/**
 * @license
 * @qwik.dev/core 2.0.0-0-dev+3e21dd9
...
const vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
    ...
    function expectComponent(component) {
        ...
        if (componentMeta) {
            ...
            jsxValue.key && vnode_setProp(vNewNode, ELEMENT_KEY, jsxValue.key)), host = vNewNode), 
            host) {
        ...
        if (Array.isArray(value)) {
            ...
            if ("string" == typeof type) {
                ...
                if (type === Fragment) {
                    ...
                    ssr.openFragment(isDev ? [ DEBUG_TYPE, VirtualType.InlineComponent, ...inlineComponentProps ] : inlineComponentProps), 
                    enqueue(ssr.closeFragment);
...
const version = "2.0.0-0-dev+3e21dd9";
