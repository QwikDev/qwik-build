/**
 * @license
 * @builder.io/qwik 2.0.0-0-dev+9f8b88f
 * Copyright Builder.io, Inc. All Rights Reserved.
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://github.com/QwikDev/qwik/blob/main/LICENSE
 */
import { isServer, isDev, isBrowser } from "@builder.io/qwik/build";
...
const version = "2.0.0-0-dev+9f8b88f";
...
const vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
    ...
    function expectComponent(component) {
        ...
        if (componentMeta) {
            ...
            null != currentJSX.children && function(children, host) {
            ...
            }(currentJSX.children, host);
        } else {
            vnode_insertBefore(journal, vParent, vNewNode = vnode_newVirtual(), vCurrent && getInsertBefore()), 
            isDev && vnode_setProp(vNewNode, DEBUG_TYPE, VirtualType.InlineComponent), vnode_setProp(vNewNode, "q:props", currentJSX.props), 
            host = vNewNode;
    ...
    if (null == value) {
        ...
        if (Array.isArray(value)) {
            ...
            if ("string" == typeof type) {
                !directGetPropsProxyProp(jsx.varProps, jsx.constProps, "class") && styleScoped && (jsx.constProps || (jsx.constProps = {}), 
...
function appendQwikInspectorAttribute(jsx) {
    if (isDev && qInspector && jsx.dev && "head" !== jsx.type) {
        ...
        sanitizedFileName && !directGetPropsProxyProp(jsx.varProps, jsx.constProps, qwikInspectorAttr) && (jsx.constProps || (jsx.constProps = {}), 
...
const directGetPropsProxyProp = (varProps, constProps, prop) => constProps && prop in constProps ? constProps[prop] : varProps[prop];

const getMergedProps = props => ({
    ...props[_VAR_PROPS],
    ...props[_CONST_PROPS],
