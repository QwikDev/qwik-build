...
const vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
    ...
    function expectSlot() {
        ...
        const slotNameKey = function(vHost) {
            ...
            return directGetPropsProxyProp(jsxValue, "name") || "";
        }(vHost);
    ...
    function expectVirtual(type, jsxKey) {
        vCurrent && vnode_isVirtualVNode(vCurrent) && vnode_getProp(vCurrent, "q:key", null) === jsxKey || (null === jsxKey || (vNewNode = retrieveChildWithKey(null, jsxKey), 
    ...
    function expectComponent(component) {
        ...
        if (componentMeta) {
            ...
            isDev && vnode_setProp(vNewNode, "q:type", VirtualType.InlineComponent), vnode_setProp(vNewNode, "q:props", jsxValue.props), 
            jsxValue.key && vnode_setProp(vNewNode, "q:key", jsxValue.key)), host = vNewNode), 
            host) {
    ...
    function insertNewComponent(host, componentQRL, jsxProps) {
        ...
        container.setHostProp(vNewNode, "q:props", jsxProps), container.setHostProp(vNewNode, "q:key", jsxValue.key);
    }
...
function processJSXNode(ssr, enqueue, value, options) {
    if (null == value) {
        ...
        if (Array.isArray(value)) {
            ...
            ssr.openFragment(isDev ? [ "q:type", VirtualType.WrappedSignal ] : EMPTY_ARRAY);
            ...
            ssr.openFragment(isDev ? [ "q:type", VirtualType.Awaited ] : EMPTY_ARRAY), enqueue(ssr.closeFragment), 
            ...
            if ("string" == typeof type) {
                ...
                if (type === Fragment) {
                    ...
                    isDev && (attrs = [ "q:type", VirtualType.Fragment, ...attrs ]), ssr.openFragment(attrs), 
                    ...
                    if (componentFrame) {
                        ...
                        ssr.openFragment(isDev ? [ "q:type", VirtualType.Projection ] : EMPTY_ARRAY), ssr.closeFragment();
                    }
                    ...
                    ssr.openComponent(isDev ? [ "q:type", VirtualType.Component ] : []);
                    const host = ssr.getLastNode();
                    ...
                    ssr.openFragment(isDev ? [ "q:type", VirtualType.InlineComponent, ...inlineComponentProps ] : inlineComponentProps), 
                    enqueue(ssr.closeFragment);
...
class JSXNodeImpl {
    constructor(type, varProps, constProps, children, flags, key = null) {
        this.type = type, this.varProps = varProps, this.constProps = constProps, this.children = children, 
        this.flags = flags, this.key = key, this._proxy = null;
    }
    get props() {
