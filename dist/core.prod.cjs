...
!function(global, factory) {
    ...
    const injectQContainer = containerEl => {
        directSetAttribute(containerEl, "q:version", "1.10.0"), directSetAttribute(containerEl, "q:container", "resumed"), 
    ...
    globalThis.__qwik_reg_symbols.set(hash, symbol), symbol), exports._renderSSR = async (node, opts) => {
        ...
        containerAttributes["q:container"] = "paused", containerAttributes["q:version"] = "1.10.0", 
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "1.10.0", exports.withLocale = function(locale, fn) {
