/**
 * @license
 * @builder.io/qwik/server 1.14.0-dev+19ad014
...
var preloaderPre = (base2, resolvedManifest, options, beforeContent, nonce) => {
  var _a;
  const preloadChunk = (_a = resolvedManifest == null ? void 0 : resolvedManifest.manifest) == null ? void 0 : _a.preloader;
  if (preloadChunk && options !== false) {
    ...
    const hash2 = resolvedManifest == null ? void 0 : resolvedManifest.manifest.manifestHash;
    ...
    beforeContent.push(
       ...
       * html download
       */
      (0, import_qwik3.jsx)("link", { rel: "modulepreload", href: `${base2}${preloadChunk}` }),
      (0, import_qwik3.jsx)("link", {
        rel: "preload",
        href: `${base2}q-bundle-graph-${resolvedManifest == null ? void 0 : resolvedManifest.manifest.manifestHash}.json`,
        as: "fetch",
    ...
    if (core) {
      beforeContent.push((0, import_qwik3.jsx)("link", { rel: "modulepreload", href: `${base2}${core}` }));
    }
  }
};
var includePreloader = (base2, resolvedManifest, options, referencedBundles, nonce) => {
  ...
  const preloadChunk = manifestHash && (resolvedManifest == null ? void 0 : resolvedManifest.manifest.preloader);
  if (preloadChunk) {
...
async function renderToStream(rootNode, opts) {
  ...
  preloaderPre(buildBase, resolvedManifest, opts.preloader, beforeContent, (_d = opts.serverData) == null ? void 0 : _d.nonce);
