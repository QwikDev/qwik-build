/**
 * @license
 * @builder.io/qwik/optimizer 2.0.0-0-dev+1da95e2
...
function createPlugin(optimizerOptions = {}) {
  ...
  const normalizeOptions = inputOpts => {
    ...
    opts.isDev = updatedOpts.isDev ?? "development" === opts.buildMode;
...
var fromCamelToKebabCase2 = text => text.replace(/([A-Z-])/g, "-$1").toLowerCase();
...
function clearSubscriberDependencies(value) {
  if (value.$dependencies$) {
    for (let i = value.$dependencies$.length - 1; i >= 0; i--) {
      ...
      const subscriptionRemoved = clearSubscriptions(subscriber, value);
      subscriptionRemoved && value.$dependencies$.splice(i, 1);
    }
  }
}
...
var executeComponent2 = (container, renderHost, subscriptionHost, componentQRL, props) => {
  ...
  const executeComponentWithPromiseExceptionRetry = () => safeCall((() => {
    ...
    vnode_isVNode(renderHost) && clearVNodeDependencies(renderHost);
...
var vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
      ...
      while (jsxIdx < jsxCount) {
        ...
        if ("string" === typeof jsxValue) {
          ...
          if (Array.isArray(jsxValue)) {
            ...
            vCurrent && clearVNodeDependencies(vCurrent);
            expectVirtual("S", null);
            descend(trackSignal2((() => jsxValue.value), vNewNode || vCurrent, ".", container), true);
  ...
  function getSlotNameKey(vHost) {
    ...
    if (constProps && "object" == typeof constProps && "name" in constProps) {
      ...
      if (constValue instanceof WrappedSignal) {
        return trackSignal2((() => constValue.value), vHost, ":", container);
      }
    }
  ...
  function createNewElement(jsx2, elementName) {
    ...
    if (constProps) {
      for (const key2 in constProps) {
        ...
        isSignal2(value) && (value = trackSignal2((() => value.value), vNewNode, key2, container, scopedStyleIdPrefix));
  ...
  function setBulkProps(vnode, srcAttrs) {
    ...
    const record = (key, value) => {
      ...
      isSignal2(value) && (value = untrack((() => value.value)));
  ...
  function insertNewComponent(host, componentQRL, jsxProps) {
    host && clearVNodeDependencies(host);
    vnode_insertBefore(journal, vParent, vNewNode = vnode_newVirtual(), vCurrent && getInsertBefore());
...
function markVNodeAsDeleted(vNode, vParent, vCursor) {
  if (vNode !== vCursor) {
    ...
    const isParentProjection = currentVParent && null !== vnode_getProp(currentVParent, QSlot, null);
    isParentProjection || (vCursor[0] |= 32);
  }
}
...
var createScheduler = (container, scheduleDrain, journalFlush) => {
  ...
  function executeChore(chore) {
    ...
    switch (chore.$type$) {
     ...
     case 7:
     case 6:
      returnValue = safeCall((() => executeComponent2(container, host, host, chore.$target$, chore.$payload$)), (jsx3 => 7 === chore.$type$ ? maybeThen(container.processJsx(host, jsx3), (() => jsx3)) : jsx3), (err => container.handleError(err, host)));
      break;
     ...
     case 4:
      ...
      isSignal2(jsx2) && (jsx2 = jsx2.value);
...
var version = "2.0.0-0-dev+1da95e2";
...
var getStoreHandler2 = value => value[STORE_HANDLER];

var getStoreTarget2 = value => value?.[STORE_TARGET] || null;

var unwrapStore2 = value => getStoreTarget2(value) || value;
...
var getOrCreateStore2 = (obj, flags, container) => {
...
var StoreHandler = class {
  ...
  get(target, prop) {
    ...
    if (1 & flags && "object" === typeof value && null !== value && !Object.isFrozen(value) && !isStore2(value) && !Object.isFrozen(target)) {
  ...
  set(target, prop, value) {
    ...
    const newValue = 1 & this.$flags$ ? unwrapStore2(value) : value;
    if (prop in target) {
      const oldValue = target[prop];
      if (newValue !== oldValue) {
        DEBUG2 && log("Signal.set", oldValue, "->", newValue, pad("\n" + this.toString(), "  "));
        setNewValueAndTriggerEffects(prop, newValue, target, this);
      }
    } else {
      DEBUG2 && log("Signal.set", "create property", newValue, pad("\n" + this.toString(), "  "));
      setNewValueAndTriggerEffects(prop, newValue, target, this);
    }
    return true;
  }
...
var DeserializationHandler = class {
  ...
  get(target, property, receiver) {
    ...
    if (void 0 !== getStoreTarget2(target)) {
      ...
      if ("string" === typeof unwrappedPropValue && unwrappedPropValue.length >= 1 && 5 === unwrappedPropValue.charCodeAt(0)) {
        return allocate(unwrappedPropValue);
      }
    }
    let propValue = Reflect.get(target, property, receiver);
    let typeCode;
    if ("string" === typeof propValue && propValue.length >= 1 && (typeCode = propValue.charCodeAt(0)) < 32) {
      ...
      if (1 === typeCode) {
        ...
        propValue = "" === propValue ? container.element.ownerDocument : vnode_locate(container.rootVNode, propValue.substring(1));
      } else if (23 === typeCode) {
        propValue = deserializeStore2(container, propValue);
      } else {
        if (21 === typeCode && !Array.isArray(target)) {
      ...
      if ("string" !== typeof propValue || propValue.length > 0 && propValue.charCodeAt(0) >= 32) {
        Reflect.set(target, property, propValue, receiver);
        typeCode >= 15 && inflate(container, propValue, serializedValue);
      }
    }
  ...
  set(target, property, newValue, receiver) {
    if ("string" === typeof newValue && newValue.length >= 1 && newValue.charCodeAt(0) < 32) {
...
function upgradePropsWithDerivedSignal(container, target, property) {
  ...
  for (const key in target) {
    if (Object.prototype.hasOwnProperty.call(target, key)) {
      ...
      if ("string" === typeof value && 21 === value.charCodeAt(0)) {
...
var restInt = () => parseInt(restString());
...
var allocate = value => {
  switch (value.charCodeAt(0)) {
   ...
   case 7:
    ...
    const isNaN = 0 === type.length;
    if (isNaN) {
      return Number.NaN;
    }
    {
      const isNegativeInfinity = "-" === type;
      return isNegativeInfinity ? -1 / 0 : 1 / 0;
    }
   ...
   case 30:
    ...
    const rest2 = 3 & encodedLength;
    const decodedLength = 3 * blocks + (rest2 ? rest2 - 1 : 0);
...
function parseQRL(qrl) {
  ...
  const chunk = hashIdx > -1 ? qrl.substring(qrl.charCodeAt(0) < 32 ? 1 : 0, hashIdx) : qrl;
...
var createSerializationContext = (NodeConstructor, symbolToChunkResolver, setProp, writer) => {
  ...
  const $addRoot$ = obj => {
    let id = map.get(obj);
    if ("number" !== typeof id || id === Number.MIN_SAFE_INTEGER) {
      id = roots.length;
      map.set(obj, id);
      roots.push(obj);
    }
  ...
  function breakCircularDependenciesAndResolvePromises(rootObj, promises) {
    ...
    while (discoveredValues.length) {
      ...
      if (shouldTrackObj(obj) || frameworkType(obj)) {
        ...
        if (void 0 === id || isRoot) {
          !isRoot && $seen$(obj);
          if ("object" !== typeof obj || null === obj || obj instanceof URL || obj instanceof Date || obj instanceof RegExp || obj instanceof Error || obj instanceof Date || obj instanceof Uint8Array || obj instanceof URLSearchParams || "undefined" !== typeof FormData && obj instanceof FormData) {} else if (fastSkipSerialize(obj)) {} else if (unwrapObj !== obj) {
...
function serialize(serializationContext) {
  const {$writer$: $writer$, $addRoot$: $addRoot$, $NodeConstructor$: $NodeConstructor$, $setProp$: $setProp$} = serializationContext;
  let depth = -1;
  const writeString = text => {
    text = JSON.stringify(text);
    let angleBracketIdx = -1;
    let lastIdx = 0;
    while (-1 !== (angleBracketIdx = text.indexOf("</", lastIdx))) {
  ...
  const writeValue = (value, idx) => {
    ...
    if ("bigint" === typeof value) {
      return writeString("\b" + value.toString());
    }
    if ("boolean" === typeof value) {
      $writer$.write(String(value));
    } else if ("function" === typeof value) {
      if (isQrl2(value)) {
        writeString("" + qrlToString(serializationContext, value));
      } else if (isQwikComponent(value)) {
        const [qrl] = value[SERIALIZABLE_STATE];
        serializationContext.$renderSymbols$.add(qrl.$symbol$);
        writeString("" + qrlToString(serializationContext, qrl));
      } else {
  ...
  const writeObjectValue = (value, idx) => {
    ...
    if (fastSkipSerialize(value)) {
      ...
      writeString("" + varId + " " + constId);
    } else if (isStore2(value)) {
      const storeHandler = getStoreHandler2(value);
      let store = "" + $addRoot$(unwrapStore2(value)) + " " + storeHandler.$flags$;
      ...
      if (effects) {
        ...
        effects[STORE_ARRAY_PROP] && (store += sep + "\0" + serializeEffectSubs($addRoot$, effects[STORE_ARRAY_PROP]));
      }
      writeString(store);
      ...
      writeString(value instanceof WrappedSignal ? "" + serializeDerivedFn(serializationContext, value, $addRoot$) + ";" + $addRoot$(value.$dependencies$) + ";" + $addRoot$(value.untrackedValue) + serializeEffectSubs($addRoot$, value.$effects$) : value instanceof ComputedSignal2 ? "" + qrlToString(serializationContext, value.$computeQrl$) + ";" + $addRoot$(value.$dependencies$) + ";" + $addRoot$(value.$untrackedValue$) + serializeEffectSubs($addRoot$, value.$effects$) : "" + $addRoot$(value.$dependencies$) + ";" + $addRoot$(value.$untrackedValue$) + serializeEffectSubs($addRoot$, value.$effects$));
      ...
      const errorProps = Object.assign({
        ...
        stack: isDev2 ? value.stack : "<hidden>"
      }, value);
      writeString("" + $addRoot$(errorProps));
      ...
      writeString("" + serializeJSXType($addRoot$, value.type) + " " + $addRoot$(value.varProps) + " " + $addRoot$(value.constProps) + " " + $addRoot$(value.children) + " " + value.flags + " " + (value.key || ""));
    } else if (value instanceof Task2) {
      writeString("" + value.$flags$ + " " + value.$index$ + " " + $addRoot$(value.$el$) + " " + $addRoot$(value.$dependencies$) + " " + qrlToString(serializationContext, value.$qrl$) + (null == value.$state$ ? "" : " " + $addRoot$(value.$state$)));
...
var frameworkType = obj => "object" === typeof obj && null !== obj && (obj instanceof Signal2 || obj instanceof Task2 || isJSXNode(obj)) || isQrl2(obj);
...
var canSerialize2 = value => {
  ...
  if ("object" === typeof value) {
    ...
    isStore2(value) && (value = unwrapStore2(value));
...
var vnode_insertBefore = (journal, parent, newChild, insertBefore2) => {
  ...
  null == insertBefore2 ? vnode_isVirtualVNode(parent) && (adjustedInsertBefore = vnode_getDomSibling(parent, true, false)) : adjustedInsertBefore = vnode_isVirtualVNode(insertBefore2) ? vnode_getDomSibling(insertBefore2, true, true) : insertBefore2;
...
var isQStyleElement = node => isElement2(node) && "STYLE" === node.nodeName && (node.hasAttribute(QScopedStyle) || node.hasAttribute(QStyle));
...
var isElement2 = node => node && "object" == typeof node && 1 === fastNodeType(node);
...
var isSignal2 = value => value instanceof Signal2;

var Signal2 = class extends Subscriber {
  ...
  if (effects) {
    const scheduleEffect = effectSubscriptions => {
      ...
      if (isTask(effect)) {
        ...
        effect instanceof ComputedSignal2 && (effect.$computeQrl$.resolved || container.$scheduler$(1, null, effect.$computeQrl$));
        effect.$invalid$ = true;
...
var ComputedSignal2 = class extends Signal2 {
...
var WrappedSignal = class extends Signal2 {
  ...
  $computeIfNeeded$() {
    ...
    this.$untrackedValue$ = trackSignal2((() => this.$func$(...this.$args$)), this, ".", this.$container$);
  }
  get value() {
    return super.value;
  }
...
var handleClass = (ctx, elm, newValue) => {
  ...
  elm.namespaceURI === SVG_NS2 ? setAttribute(ctx, elm, "class", newValue) : setProperty(ctx, elm, "className", newValue);
  return true;
};
...
var runTask2 = (task, container, host) => {
  ...
  const track = (obj, prop) => {
    ...
    return invoke(ctx, (() => {
      ...
      return prop ? obj[prop] : isSignal2(obj) ? obj.value : obj;
    }));
  };
  ...
  const result = safeCall((() => taskFn(taskApi)), cleanup2, (err => isPromise(err) ? err.then((() => runTask2(task, container, host))) : handleError2(err)));
  return result;
};
...
var trackSignal2 = (fn, subscriber, property, container, data = null) => {
...
var SignalImpl = class extends SignalBase {
  ...
  set value(v) {
    if (qDev) {
      ...
      invokeCtx && (invokeCtx.$event$ === RenderEvent ? logWarn("State mutation inside render function. Use useTask$() instead.", String(invokeCtx.$hostElement$)) : invokeCtx.$event$ === ComputedEvent && logWarn("State mutation inside useComputed$() is an antipattern. Use useTask$() instead", String(invokeCtx.$hostElement$)));
    }
