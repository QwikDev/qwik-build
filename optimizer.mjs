/**
 * @license
 * @builder.io/qwik/optimizer 0.105.0
...
var QWIK_LOADER_DEFAULT_MINIFIED = global.QWIK_LOADER_DEFAULT_MINIFIED;

var QWIK_LOADER_DEFAULT_DEBUG = global.QWIK_LOADER_DEFAULT_DEBUG;
