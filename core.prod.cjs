...
!function(global, factory) {
    ...
    const executeComponent2 = (container, renderHost, subscriptionHost, componentQRL, props) => {
        ...
        let componentFn;
        if (iCtx.$subscriber$ = [ exports.SubscriptionType.HOST, subscriptionHost ], iCtx.$container2$ = container, 
    ...
    const vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
                ...
                for (;jsxIdx < jsxCount; ) {
                    if (assertFalse(vParent === vCurrent, "Parent and current can't be the same"), "string" == typeof jsxValue) {
                        ...
                        if (Array.isArray(jsxValue)) {
                            ...
                            expectVirtual(VirtualType.DerivedSignal, null), descend(trackSignal(jsxValue, [ exports.SubscriptionType.TEXT_MUTABLE, vCurrent || vNewNode, jsxValue, vCurrent || vNewNode ]), !0);
            ...
            const slotNameKey = function(vHost) {
                ...
                if (constProps && "object" == typeof constProps && "name" in constProps) {
                    ...
                    if (constValue instanceof SignalDerived) {
                        return trackSignal(constValue, [ exports.SubscriptionType.HOST, vHost ]);
                    }
                }
            ...
            if (constProps) {
                for (const key in constProps) {
                    ...
                    if (isJsxPropertyAnEventName(key)) {
                        ...
                        if (isSignal(value) && (value = trackSignal(value, [ exports.SubscriptionType.PROP_IMMUTABLE, vNewNode, value, vNewNode, key, scopedStyleIdPrefix || void 0 ])), 
        ...
        function expectComponent(component) {
            ...
            if (componentMeta) {
                ...
                vnode_setProp(vNewNode, "q:props", jsxValue.propsC), host = vNewNode;
    ...
    const createScheduler = (container, scheduleDrain, journalFlush) => {
        ...
        function executeChore(chore) {
            ...
            return thenFn = value => (currentChore?.$resolve$?.(value), currentChore = null, 
            chore.$returnValue$ = value), isPromise(promise = returnValue) ? promise.then(thenFn) : thenFn(promise);
            var promise, thenFn;
        }
    };
    ...
    const renderNode = (node, rCtx, ssrCtx, stream, flags, beforeClose) => {
        ...
        if ("string" == typeof tagName) {
            ...
            const handleProp = (rawProp, value, isImmutable) => {
                ...
                value = trackSignal(value, isImmutable ? [ exports.SubscriptionType.PROP_IMMUTABLE, elm, value, hostCtx.$element$, rawProp, void 0 ] : [ exports.SubscriptionType.PROP_MUTABLE, hostCtx.$element$, value, elm, rawProp, void 0 ]), 
            ...
            if (!isString(node) && "number" != typeof node) {
                ...
                if (isSignal(node)) {
                    ...
                    if (hostEl) {
                        if (!insideText) {
                            const id = getNextIndex(rCtx);
                            if (value = trackSignal(node, 1024 & flags ? [ exports.SubscriptionType.TEXT_IMMUTABLE, "#" + id, node, "#" + id ] : [ exports.SubscriptionType.TEXT_MUTABLE, hostEl, node, "#" + id ]), 
                            isString(value)) {
    ...
    function processJSXNode(ssr, enqueue, value, styleScoped) {
        if (null == value) {
            ...
            if (Array.isArray(value)) {
                ...
                ssr.openFragment(build.isDev ? [ DEBUG_TYPE, VirtualType.DerivedSignal ] : EMPTY_ARRAY);
                const signalNode = ssr.getLastNode();
                const host = signalNode;
                enqueue(ssr.closeFragment), enqueue(trackSignal(value, [ exports.SubscriptionType.TEXT_MUTABLE, host, value, signalNode ]));
                ...
                if ("string" == typeof type) {
                    ...
                    if (type === Fragment) {
                        ...
                        if (componentFrame) {
                            ...
                            const slotName = function(host, jsx) {
                                const constProps = jsx.constProps;
                                if (constProps && "object" == typeof constProps && "name" in constProps) {
                                    const constValue = constProps.name;
                                    if (constValue instanceof SignalDerived) {
                                        return trackSignal(constValue, [ exports.SubscriptionType.HOST, host ]);
                                    }
                                }
        ...
        if (qDev) {
            ...
            invoke(void 0, (() => {
                ...
                if (children) {
                    ...
                    })), build.isBrowser && (isFunction(type) || constProps)) {
                        const keys = {};
                ...
                !function(serializationContext) {
                    ...
                    const writeObjectValue = (value, idx) => {
                        ...
                        if (fastSkipSerialize(value)) {
                            ...
                            })(value) && serializationContext.$resources$.add(value), serializeObjectLiteral(value, $writer$, writeValue, writeString, serializationContext.$proxyMap$, $addRoot$);
                            ...
                            const serializedSignalDerived = function(serializationContext, value, $addRoot$) {
                            ...
                            }(serializationContext, value, $addRoot$);
                    ...
                    const serializeObjectLiteral = (value, $writer$, writeValue, writeString, objectMap, $addRoot$) => {
                        if (Array.isArray(value)) {
                            ...
                            function(value, $writer$, writeValue) {
                                $writer$.write("[");
                                for (let i = 0; i < value.length; i++) {
                                    0 !== i && $writer$.write(","), writeValue(value[i], i);
                                }
                                $writer$.write("]");
                            }(value, $writer$, writeValue), void 0 !== proxy && $writer$.write("}");
                        } else {
                            $writer$.write("{");
                            const proxy = objectMap.get(value);
                            void 0 !== proxy && serializeProxy(value, proxy, $writer$, writeString, $addRoot$), 
                            function(value, $writer$, writeValue, writeString, startWithDelimiter) {
                            ...
                            }(value, $writer$, writeValue, writeString, void 0 !== proxy), $writer$.write("}");
                        }
                    };
    ...
    const resumeContainer = containerEl => {
        ...
        el = containerEl, eventName = "qresume", detail = void 0, bubbles = !0, (build.isBrowser || "function" == typeof CustomEvent) && el && el.dispatchEvent(new CustomEvent(eventName, {
            detail,
            bubbles,
            composed: bubbles
        }));
    ...
    const diffVnode = (rCtx, oldVnode, newVnode, flags) => {
        ...
        newVnode.$elm$ = elm, "#text" === tag) {
            ...
            return signal && (newVnode.$text$ = jsxToString(trackSignal(signal, [ exports.SubscriptionType.TEXT_MUTABLE, currentComponent.$element$, signal, elm ]))), 
                ...
                for (const prop in props) {
                    ...
                    if ("ref" !== prop) {
                        if (isOnProp(prop)) {
                            ...
                            isSignal(newValue) && (newValue = trackSignal(newValue, [ exports.SubscriptionType.PROP_IMMUTABLE, currentComponent.$element$, newValue, elm, prop, void 0 ])), 
        ...
        if ("#signal" === tag) {
            ...
            if (isJSXNode(signalValue)) {
                ...
                }
                {
                    ...
                    return trackSignal(signal, 4 & flags ? [ exports.SubscriptionType.TEXT_IMMUTABLE, elm, signal, elm ] : [ exports.SubscriptionType.TEXT_MUTABLE, currentComponent.$element$, signal, elm ]), 
                    vnode.$elm$ = elm;
                }
            }
            {
                const elm = doc.createTextNode(vnode.$text$);
                return elm.data = vnode.$text$ = jsxToString(signalValue), trackSignal(signal, 4 & flags ? [ exports.SubscriptionType.TEXT_IMMUTABLE, elm, signal, elm ] : [ exports.SubscriptionType.TEXT_MUTABLE, currentComponent.$element$, signal, elm ]), 
                vnode.$elm$ = elm;
            }
        }
        let elm;
        ...
        for (const prop in newProps) {
            ...
            if ("ref" !== prop) {
                if (isOnProp(prop)) {
                    ...
                    newValue = trackSignal(newValue, immutable ? [ exports.SubscriptionType.PROP_IMMUTABLE, elm, newValue, hostCtx.$element$, prop, void 0 ] : [ exports.SubscriptionType.PROP_MUTABLE, hostCtx.$element$, newValue, elm, prop, void 0 ])), 
                    "class" === prop) {
    ...
    exports._DomContainer = DomContainer, exports._EMPTY_ARRAY = EMPTY_ARRAY, exports._IMMUTABLE = _IMMUTABLE, 
