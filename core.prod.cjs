...
!function(global, factory) {
    ...
    class _SharedContainer {
        constructor(scheduleDrain, journalFlush, serverData, locale) {
            ...
            this.$locale$ = locale, this.$version$ = "2.0.0-0-dev+4dd471d", this.$storeProxyMap$ = new WeakMap, 
            this.$getObjectById$ = () => {
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "2.0.0-0-dev+4dd471d", 
