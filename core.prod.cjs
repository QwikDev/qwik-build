...
!function(global, factory) {
    ...
    class _SharedContainer {
        constructor(scheduleDrain, journalFlush, serverData, locale) {
            ...
            this.$locale$ = locale, this.$version$ = "2.0.0-0-dev+3e21dd9", this.$storeProxyMap$ = new WeakMap, 
            this.$getObjectById$ = () => {
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "2.0.0-0-dev+3e21dd9", 
