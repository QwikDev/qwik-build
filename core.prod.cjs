...
!function(global, factory) {
    ...
    const executeComponent = (container, renderHost, subscriptionHost, componentQRL, props) => {
        ...
        container.ensureProjectionResolved(renderHost), null === componentQRL && (componentQRL = componentQRL || container.getHostProp(renderHost, "q:renderFn"), 
    ...
    const vnode_diff = (container, jsxNode, vStartNode, scopedStyleIdPrefix) => {
        ...
        function expectComponent(component) {
            ...
            if (componentMeta) {
                ...
                build.isDev && vnode_setProp(vNewNode, "q:type", VirtualType.InlineComponent), vnode_setProp(vNewNode, "q:props", jsxValue.props), 
    ...
    class _SharedContainer {
        constructor(scheduleDrain, journalFlush, serverData, locale) {
            ...
            this.$locale$ = locale, this.$version$ = "2.0.0-0-dev+8a5a778", this.$storeProxyMap$ = new WeakMap, 
            this.$getObjectById$ = () => {
    ...
    class DomContainer extends _SharedContainer {
        constructor(element) {
            ...
            this.$getObjectById$ = id => ("string" == typeof id && (id = parseFloat(id)), assertTrue(), 
    ...
    exports.useVisibleTaskQrl = useVisibleTaskQrl, exports.version = "2.0.0-0-dev+8a5a778", 
