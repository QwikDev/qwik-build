/**
 * @license
 * @builder.io/qwik/server 2.0.0-0-dev+9f8b88f
    ...
    if (children.length) {
      ...
      for (let i = 0; i < children.length; i++) {
        ...
        const slotName = String(
          isJSXNode(child) && directGetPropsProxyProp(child.varProps, child.constProps, QSlot) || QDefaultSlot
        );
...
var directGetPropsProxyProp = (varProps, constProps, prop) => {
  return constProps && prop in constProps ? constProps[prop] : varProps[prop];
};
