...
function linkHtmlImplementation(prefetchResources, prefetchImpl) {
  ...
  for (const url of urls) {
    ...
    links.push((0, import_qwik2.jsx)("link", attributes, void 0));
  }
  return (0, import_qwik2.jsx)(import_qwik2.Fragment, { children: links });
}
...
async function renderToStream(rootNode, opts) {
  ...
  await (0, import_qwik3.renderSSR)(doc, rootNode, {
    ...
    beforeClose: async (contexts, containerState) => {
      var _a2, _b2;
      snapshotResult = await (0, import_qwik3.pauseFromContexts)(contexts, containerState);
